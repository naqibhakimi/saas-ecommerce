...
class Fulfillment(BaseModel):
    claim_order = models.ForeignKey(
        "order.ClaimOrder", on_delete=models.CASCADE, null=True, related_name="+"
    )
    swap = models.ForeignKey(
        "store.Swap", on_delete=models.CASCADE, null=True, related_name="+"
    )
    order = models.ForeignKey(
        "order.Order", on_delete=models.CASCADE, null=True, related_name="+"
    )
    no_notification = models.BooleanField(null=True)
    provider = models.ForeignKey(
        "inventory.FulfillmentProvider", on_delete=models.CASCADE
    )
...
class TrackingLink(BaseModel):
    ...
    fulfillment = models.ForeignKey(
        Fulfillment, related_name="+", on_delete=models.CASCADE
    )
