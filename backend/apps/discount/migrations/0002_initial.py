...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="product_tag",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="product.producttag"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="customer_group",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="customer.customergroup"
            ),
        ),
        migrations.AddField(
            model_name="discountconditioncustomergroup",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="discount.DiscountConditionCustomerGroup",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="discount.DiscountConditionProductCollection",
                to="product.productcollection",
            ),
        ),
        migrations.AddField(
            ...
            name="product_tags",
            field=models.ManyToManyField(
                through="discount.DiscountConditionProductTag", to="product.producttag"
            ),
        ),
        migrations.AddField(
            model_name="discountcondition",
            name="product_types",
            field=models.ManyToManyField(
                through="discount.DiscountConditionProductType",
                to="product.producttype",
            ),
        ),
        migrations.AddField(
            ...
            name="products",
            field=models.ManyToManyField(
                through="discount.DiscountConditionProduct", to="product.product"
            ),
        ),
        migrations.AddField(
            model_name="discount",
