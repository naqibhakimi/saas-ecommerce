...
import { _GET_CUSTOMERS } from '@/services/customers';
...
export default function Example() {
    ...
    const getCustomersQuery = useQuery(_GET_CUSTOMERS);
    ...
    function toggleAll() {
        setSelectedPeople(
            checked || indeterminate
                ? []
                : convertEdgeToList(getCustomersQuery.data.customers.edges),
        );
        setChecked(!checked && !indeterminate);
        setIndeterminate(false);
    }

    if (getCustomersQuery.error || getCustomersQuery.loading) {
        return (
            <Layout>
                <></>
            </Layout>
